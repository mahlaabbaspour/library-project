                    ...
                    <Grid container>
                      {shortcuts.map((shortcut, index) => (
                        <Grid
                          ...
                          key={index}
                          onClick={handleClose}
                          className='[&:not(:last-of-type):not(:nth-last-of-type(2))]:border-be odd:border-ie border-b-[1px]'
                        >
                          <Link
                            target={shortcut.url.startsWith('http') ? '_blank' : ''}
                            href={shortcut.url}
                          ...
                          >
                            ...
                            <div className='flex flex-col items-center text-center'>
                              <Typography variant='inherit'>{shortcut.title}</Typography>
                              <Typography variant='caption'>{shortcut.subtitle}</Typography>
                            </div>
                          </Link>
                        </Grid>
                      ))}
